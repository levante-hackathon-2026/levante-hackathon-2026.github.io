...
For step-by-step guidelines, visit our Researcher Site [Data Access](https://researcher.levante-network.org/data) page (under “Public data release” toggle the “How to access” subheading and instructions will appear).
...
The analysis code provided uses R/Rstudio. See our [Resources](https://levante-hackathon-2026.github.io/resources/) tab for installation instructions.

The LEVANTE hackathon curriculum will be uploaded to GitHub. You can access the files by cloning the repository to your local device. In order to do so, you may need to [install git](https://github.com/git-guides/install-git), [create a GitHub account](https://github.com/signup), and [set up ssh authentication](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/about-ssh). After you have cloned the repository, you will be able to easily pull any updated code. 
